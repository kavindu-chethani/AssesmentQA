...
(function () {
    ...
    ***************************************************************************** */
    ...
    var ChildIframeDriverLink = /** @class */ (function () {
        function ChildIframeDriverLink(driverWindow, driverId, dispatchProxylessEventUrls) {
    ...
    ActionExecutor.ACTIONS_HANDLERS[COMMAND_TYPE.pressKey] = {
        create: function (command, _a, dispatchProxylessEventFn) { return new testcafeAutomation.Press(testcafeCore.parseKeySequence(command.keys).combinations, command.options, dispatchProxylessEventFn); },
    ...
    ActionExecutor.ACTIONS_HANDLERS[COMMAND_TYPE.typeText] = {
        // eslint-disable-next-line no-restricted-properties
        create: function (command, elements, dispatchProxylessEventFn) { return new testcafeAutomation.Type(elements[0], command.text, command.options, dispatchProxylessEventFn); },
    };
    ...
    var Driver = /** @class */ (function (_super) {
        ...
        Driver.prototype._createDispatchProxylessEventFn = function (name) {
        ...
        Driver.prototype._onActionCommand = function (command) {
            ...
            var dispatchProxylessEventFn = this.options.proxyless
                ? {
    ...
    var IframeDriver = /** @class */ (function (_super) {
        ...
        IframeDriver.prototype._init = function () {
            return __awaiter(this, void 0, void 0, function () {
                var _a, id, dispatchProxylessEventUrls, inCommandExecution;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, this.parentDriverLink.establishConnection()];
                        case 1:
                            _a = _b.sent(), id = _a.id, dispatchProxylessEventUrls = _a.dispatchProxylessEventUrls;
                            this.contextStorage = new Storage(window, {
                                testRunId: id,
                                windowId: this.windowId,

...
(function () {
    ...
    ***************************************************************************** */
    ...
    function redirectUsingCdp(command, createXHR, openFileProtocolUrl) {
    ...
    function dispatchProxylessEventSequence(dispatchProxylessEventSequenceUrl, testCafeUI, createXHR, sequence) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, testCafeUI.hide()];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, sendXHR(dispatchProxylessEventSequenceUrl, createXHR, {
                                method: 'POST',
    ...
    var browser = /*#__PURE__*/Object.freeze({
        ...
        dispatchProxylessEventSequence: dispatchProxylessEventSequence,
